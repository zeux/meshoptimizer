...
var MeshoptEncoder = (function () {
	...
	return {
		...
		reorderPoints: function (positions, positions_stride) {
			...
			return spatialsort(
				instance.exports.meshopt_spatialSortRemap,
				positions,
				positions.length / positions_stride,
				positions_stride * 4,
			);
		},
		...
		encodeFilterExp: function (source, count, stride, bits, mode) {
			...
			return filter(
				instance.exports.meshopt_encodeFilterExp,
				source,
				count,
				stride,
				bits,
